    ...
    <View style={styles.wrapper}>
      <View style={styles.innerRow}>
        <View style={styles.priceLayer}>
          <Text style={styles.price}>{`\IDR ${item.totalPrice}`}</Text>
        </View>
        ...
        <View style={styles.row}>
          <View>
            <Text style={styles.serve}>{item.productId.title}</Text>
            ...
            <Text style={[styles.adText, {color: COLORS.gray, fontSize: 13}]}>{`${item.productId.ratingCount} rating reviews`}</Text>
          </View>
        </View>
      </View>
    </View>
