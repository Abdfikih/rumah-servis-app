...
const PickedDelivery = ({ navigation }) => {
  ...
  const pickOrder = async () => {
    ...
    const courier = JSON.parse(driver);
    if (driver === null) {
      navigation.navigate("registration");
    }
    const endpoint = "http://10.0.2.2:6002/api/orders/delivered/" + item._id;
    try {
  ...
  const toClient = calculateDistance(placeList[0], placeList[1]);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={{ position: "absolute", zIndex: 0, bottom: 30, left: 10 }}>
          <View
            style={{
          ...
          >
            ...
            >
              <View>
                ...
                <MapText text={`📍 ${item.shopId.coords.address} `} />
              </View>
            </View>
        ...
        <View style={{ position: "absolute", zIndex: 0, top: 90, left: 10 }}>
          ...
          >
            ...
            >
              Order from {item.shopId.title} to
            </Text>
