...
const LoginPage = ({ navigation }) => {
  ...
  const loginFunc = async (values) => {
    ...
    try {
      const endpoint = "http://10.0.2.2:6002/login";
      const data = values;
    ...
    <ScrollView style={{ backgroundColor: COLORS.white }}>
      <View style={{ marginHorizontal: 20, marginTop: 50 }}>
        ...
        <LottieView
          autoPlay
          ref={animation}
          style={{ width: "100%", height: 400, marginLeft: 40, marginTop: -30, marginBottom: -100 }}
          source={require("../../assets/anime/delivery.json")}
        />

        <Text style={styles.titleLogin}>Rumah Servis</Text>
