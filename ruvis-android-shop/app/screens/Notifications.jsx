...
const Notificaxions = ({ navigation }) => {
  ...
  const pickOrder = async () => {
    ...
    const endpoint = `http://10.0.2.2:6002/api/orders/picked-orders/${item._id}/${data._id}`;
    try {
      ...
      >
          ...
          >
            ...
            >
              <View>
                ...
                <MapText
                  text={`🏡   ${item.deliveryAddress.addressLine1}${" "}${
        ...
        <View style={{ position: "absolute", zIndex: 0, top: 90, left: 10 }}>
          ...
          >
            ...
            >
              Pick order from {item.shopId.title}
            </Text>

            <Text style={styles.restAd}>📍 {item.shopId.coords.address}</Text>
          </View>
        </View>
      </View>
    </View>
